...
if __name__ == '__main__':
    ...
    argparser.add_argument('-c', action='store', dest='threshold_c', type=float, nargs='+', help="Threshold for clustering (use space to separate multiple thresholds)")
    ...
    argparser.add_argument('-s', action='store_true', dest='separation', help="Separate clusters for improvement")
